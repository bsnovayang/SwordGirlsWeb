...
['js/data/cards.js', 'js/data/cards_ep1.js', 'js/data/cards_ep2.js', 'js/data/cards_ep3.js', 'js/data/cards_ep4.js', 'js/data/cards_ex1.js', 'js/data/cards_ep5.js', 'js/data/cards_ep6.js', 'js/data/cards_ex2.js', 'js/data/cards_npc.js', 'js/data/materials.js', 'js/data/decks.js',
 ...
 'js/core/effects.js', 'js/core/effects_ep1.js', 'js/core/effects_ep2.js', 'js/core/effects_ep3.js', 'js/core/effects_ep4.js', 'js/core/effects_ex1.js', 'js/core/effects_ep5.js', 'js/core/effects_ep6.js', 'js/core/effects_ex2.js', 'js/core/ai.js', 'js/ui/card_ui.js', 'js/ui/battle_ui.js',
...
console.log('══════ 初始存檔 ══════');
{
  ...
  eq(collectible, 492, '可收集卡片 492 種（Episode 0～6 ＋ EX1／EX2，代幣卡不算）');
...
console.log('══════ 卡片圖鑑 ══════');
{
  ...
  eq(d.querySelectorAll('#glList .crow').length, 41, '只看角色卡 → 41 張（4 主角 + 5 副本獎勵 + 各章的角色卡）');
  $('gType').value = '';
  $('gType').dispatchEvent(new w.Event('change'));
}
