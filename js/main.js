...
(function () {
  ...
  var TIPS = [
    ...
    '新手牌組的強弱原作就有差：南十字最好上手，其次私立、公立，暗黑族的初期牌效果比較微妙。',
  ...
  function rules() {
    $('rulesBody').innerHTML =
      ...
      '<p class="hint left">本作實測 AI 互打 1440 場的勝率：私立 63%／南十字 61%／' +
      '公立 52%／暗黑 24%，跟原作的說法一致。這是刻意保留的，' +
      '不是把數值調成平衡 —— 暗黑族要靠 Episode 1 之後的卡才會起來。</p>' +
      '<h3>牌組</h3><ul>' +
